...
- after any change to engine logic, run `python engines/python/test_gold_paths.py` (behavioural parity) and `python engines/python/test_engine_parity.py` (catalog parity — same systems on both sides) to verify Dart and Python engines remain in sync
